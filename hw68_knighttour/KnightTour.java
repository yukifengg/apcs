...
public class KnightTour
{
  public static void main( String[] args )
  {
    ...
    int startX = Math.random() * n;//YOUR MATH CONSTRUCT FOR GENERATING A RANDOM LEGAL X VALUE
    int startY = Math.random() * n;//YOUR MATH CONSTRUCT FOR GENERATING A RANDOM LEGAL X VALUE
