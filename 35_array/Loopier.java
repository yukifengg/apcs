...
APCS
HW35 -- // removed import java.util.Random; + import java.util.Arrays;
2021-11-15
time spent: 0.1 hour
DISCO
- na
...
public class Loopier {
    ...
    public static int[] populateArray (int size){
        ...
        arrayTest[i] = (int)(Math.random() * 10); // only random numbers from 1 to 10, can change the range, but made it smaller to easily test the frequency method
    }
    return arrayTest;
